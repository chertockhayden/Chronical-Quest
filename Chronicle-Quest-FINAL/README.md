...
## 11. After the gameplay and moderation update

If you pull in a newer version of the project, rerun [supabase/setup.sql](/Users/haydenchertock/Documents/Chronicle-Quest-FINAL/supabase/setup.sql) in the Supabase SQL Editor.

That updated SQL adds:

- moderator and teacher roles
- approval queues for questions and answers
- richer game support columns and policies

To make your own account a moderator after you have already signed up, run a query like:
...
You can also use `teacher` instead of `moderator`.
